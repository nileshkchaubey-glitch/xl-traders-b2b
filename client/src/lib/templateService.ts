...
const INSTRUCTIONS_ROWS = [
  ...
  ['category',          'No',        'Match an existing category name (or a new one is created automatically). Blank = Uncategorized.', 'Hinged Container'],
  ['unit',              'YES ✱',     'One of: pcs  box  pack  roll  kg  litre  set', 'pcs'],
  ['price',             'No',        'Wholesale price per unit (₹). Numbers only, no ₹ symbol. BLANK = "Price on enquiry" on the website.', '35'],
  ['mrp',               'No',        'Maximum Retail Price (₹). Numbers only.', '40'],
  ['moq',               'No',        'Minimum Order Quantity. Whole number. Blank = unknown.', '50'],
  ['quantity_in_unit',  'No',        'Number of individual pieces in one unit/box. Blank defaults to 1.', '100'],
  ['brand',             'No',        'Brand or manufacturer name.',                'Oshine'],
  ['sku',               'No',        'Uppercase letters + numbers + hyphens. If blank a SKU is auto-generated on import.', 'HNG-250ML'],
  ['barcode',           'No',        'EAN-13 or any barcode string. Leave blank if unknown.', '8901234567001'],
  ['description',       'No',        'Full product description. HTML not supported.', 'Hinged clamshell box for takeaway…'],
  ...
  ['master_name',       'No',        'VARIANTS ONLY — the shared parent product name. Rows sharing a master_name become size/pack variants of it. Blank = standalone product.', 'Hinged Box'],
  ['variant_label',     'No',        'VARIANTS ONLY — the label for this variant (size/pack). Combined with master_name to form the product.', '250ml'],
  [],
  ['IMPORTANT NOTES', '', '', ''],
